...
Single entry point for **vendor / repo skills** (not the 12 core slash skills + `/brain` conditional in `agents/skills/` — those ship with TAUSIK and are documented in **[Skills](skills.md)**).
