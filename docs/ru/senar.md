...
> **Почему нумерация правил пропускает 4-6?** SENAR покрывает больше, чем TAUSIK реализует. Правила 4 (внешняя проверка), 5 (контрольный список верификации — частично реализован) и 6 (планирование отката) существуют в спецификации, но пока не применяются как жёсткие блокировки. TAUSIK фокусируется на правилах с наибольшим влиянием на надёжность ИИ-агента.
