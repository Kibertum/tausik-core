...
- **Maximize parallel tool calls.** GPT-5 handles 4-6 simultaneous tool calls reliably. Don't serialize `memory_search` + `task_list --status planning` — fire both at once.
