...
|----------------|------------------------|-------------------------------------|------|
| Claude (Code, VS Code Extension) | MCP `tausik-project` + `tausik-brain` | **114** (107 project + 7 brain) | Hooks + MCP |
...
| **MCP tools (107 project + 7 brain = 114; verify-first contract)** | [docs/en/mcp.md](docs/en/mcp.md) |
...
harness/           Shared resources for all IDEs (renamed from agents/ in v1.4 to avoid collision with .claude/agents/)
  ...
  claude/mcp/      tausik-project (107) + tausik-brain (7) = 114 main; optional codebase-rag +7 → 121 total — see docs/en/mcp.md
