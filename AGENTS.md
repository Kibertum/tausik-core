...
|----------------|------------------------|-------------------------------------|------|
| Claude (Code, VS Code Extension) | MCP `tausik-project` + `tausik-brain` | **104** (97 project + 7 brain) | Hooks + MCP |
...
| **MCP tools (97 project + 7 brain = 104; verify-first contract)** | [docs/en/mcp.md](docs/en/mcp.md) |
...
harness/           Shared resources for all IDEs (renamed from agents/ in v1.4 to avoid collision with .claude/agents/)
  ...
  claude/mcp/      tausik-project (97) + tausik-brain (7) = 104 main; optional codebase-rag +7 → 111 total — see docs/en/mcp.md
