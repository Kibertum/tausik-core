...
|----------------|------------------------|-------------------------------------|------|
| Claude (Code, VS Code Extension) | MCP `tausik-project` + `tausik-brain` | **123** (116 project + 7 brain) | Hooks + MCP |
...
| **MCP tools (116 project + 7 brain = 123; verify-first contract)** | [docs/en/mcp.md](docs/en/mcp.md) |
...
harness/           Shared resources for all IDEs (renamed from agents/ in v1.4 to avoid collision with .claude/agents/)
  ...
  claude/mcp/      tausik-project (116) + tausik-brain (7) = 123 main; optional codebase-rag +7 → 130 total — see docs/en/mcp.md
