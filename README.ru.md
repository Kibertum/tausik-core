...
[![3580 tests](https://img.shields.io/badge/tests-3580%20passed-brightgreen.svg)](#dogfooding-tausik-создан-с-помощью-себя)
...
> Ядро покрыто 3580 тестами и используется на dogfood'е каждый день; если
