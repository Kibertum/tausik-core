...
[![2270 tests](https://img.shields.io/badge/tests-2270%20passed-brightgreen.svg)](#dogfooding-tausik-создан-с-помощью-себя)
...
- **96 MCP-инструментов** (90 project + 6 brain) — полный программный доступ к базе проекта
...
| Задач завершено | 516 |
| Сессий | 37 |
| Производительность | ~14 задач/сессию |
| Тестов | 2270 |
