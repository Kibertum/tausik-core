...
[![3675 tests](https://img.shields.io/badge/tests-3675%20passed-brightgreen.svg)](#dogfooding-tausik-создан-с-помощью-себя)
...
> Ядро покрыто 3675 тестами и используется на dogfood'е каждый день; если
