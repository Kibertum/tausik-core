...
[![3650 tests](https://img.shields.io/badge/tests-3650%20passed-brightgreen.svg)](#dogfooding-tausik-создан-с-помощью-себя)
...
> Ядро покрыто 3650 тестами и используется на dogfood'е каждый день; если
