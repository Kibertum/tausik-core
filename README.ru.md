...
[![3689 tests](https://img.shields.io/badge/tests-3689%20passed-brightgreen.svg)](#dogfooding-tausik-создан-с-помощью-себя)
...
> Ядро покрыто 3689 тестами и используется на dogfood'е каждый день; если
