...
- **34 навыка** — `/plan`, `/ship`, `/review`, `/audit`, `/debug`, `/test` и другие
- **80 MCP-инструментов** — полный программный доступ к базе проекта
...
- **Проектная память** — SQLite + FTS5, граф связей, трекинг тупиков
