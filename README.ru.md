...
[![3795 tests](https://img.shields.io/badge/tests-3795%20passed-brightgreen.svg)](#dogfooding-tausik-создан-с-помощью-себя)
...
> Ядро покрыто 3795 тестами и используется на dogfood'е каждый день; если
