---
slug: docs-senar-table-update
title: "CLAUDE.md SENAR table — kill drift"
status: done
...
CLAUDE.md SENAR Compliance table: update test count to live (currently 918, reality 2079+), tool count, stack count. Cross-reference with docs/. Add comment that table is mechanically validated by Makefile target.
