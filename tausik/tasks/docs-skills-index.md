---
slug: docs-skills-index
title: "agents/skills/README.md — skills catalog"
status: done
...
Index of all skills with triggers + brief description (currently scattered across SKILL.md files + CLAUDE.md mentions). Generated or hand-curated. Becomes canonical 'what /command does what'.
