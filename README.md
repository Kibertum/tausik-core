...
[![4341 tests](https://img.shields.io/badge/tests-4341-brightgreen.svg)](#proof-tausik-built-tausik)
...
- **4341 tests** — the enforcement core is the most-tested part.
...
v1.5 is a hardening release on the road to 2.0: signed receipts, fail-closed gates, external adversarial review for high-risk closures, closure-risk scoring, structured root cause. The enforcement core is **locked and covered by 4341 tests**, dogfooded daily. On uncommon paths you may still hit doc-vs-behavior drift — if you do, [file an issue](https://github.com/Kibertum/tausik-core/issues) and we'll converge it before 2.0.
