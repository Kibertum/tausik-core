...
<!-- DYNAMIC:START -->
## Current State
Session: #131 (active) | Branch: release/1.8-batch-s126 | Version: 1.7.0
Tasks: 1031/1098 done, 1 active, 0 blocked
Active: l26-agents-md
...
Decisions (5):
- #166 skills-repo-license-file закрывается won't-do: правка в чужом репо + выбор владельца; проверка лицензии ядра пройдена (A
...
Conventions (5):
- #282 Сообщение-инструкция — это код, а не текст: каждый обещанный путь (команда, флаг, файл) обязан сущес
- #280 Внешний числовой факт (цена, лимит, квота) обязан нести источник и дату сверки; тест не может быть е
